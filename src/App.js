...
import EmojiGameRules from './components/EmojiGameRules'
import RPSHomePage from './components/RPSHomePage'
...
const App = () => (
  <Switch>
    ...
    <Route exact path="/emojiGameRules" component={EmojiGameRules} />
    <Route
      exact
      path="/rockPaperScissorGame"
      component={RockPaperScissorGame}
    />
    <Route exact path="/rpsHomePage" component={RPSHomePage} />
